function declareSelectables(TILESIZE){
    ...
    selectables.checkSelection = function(){
        ...
        this.pressedKeys = this.currentRoom.p2.pressedKeys;
        ...
        if(this.pressedKeys.includes('d'))  selectables.horizontalInput += 1
        if(this.pressedKeys.includes('a'))  selectables.horizontalInput -= 1
        if(this.pressedKeys.includes('w'))  selectables.verticalInput += 1
        if(this.pressedKeys.includes('s'))  selectables.verticalInput -= 1
    }
